...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Edit a Payment Collected</div>
                <div class="card-body">
                    {{ Form::open(['action' => ['SalesPaymentController@update',$pmt->id], 'class'=>'form-horizontal', 'method'=>'post']) }}
                        @if($errors->any())
                        ...
                        <div class="form-group row">
                            ...
                            {{ Form::select('company_id', $coys, $pmt->company_id, ['class'=>'form-control col-md-10','autocomplete'=>'off']) }}
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            {{ Form::select('payment_method', [0=>'Please select',1=>'Cash',2=>'Cheque',3=>'Bank transfer'], $pmt->payment_method, ['class'=>'form-control col-sm-10','autocomplete'=>'off']) }}
                        </div>
                        <div class="form-group row">
