    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    {{ Form::open(['action' => 'PurchasePaymentController@store', 'class'=>'form-horizontal', 'method'=>'post']) }}
                        @if($errors->any())
                        ...
                        <div class="form-group row">
                            {{ Form::label('company_id', 'Customer', array('class'=>'control-label col-sm-2')) }}
                            {{ Form::select('company_id', [0=>'Please select',3=>'Crown Casino',4=>'Microsoft'], '', ['class'=>'form-control col-sm-10','autocomplete'=>'off']) }}
                        </div>
                        <div class="form-group row">
